defmodule GenCalculator do
  ...
  def start() do
    ...
    GenServer.start(GenCalculator, nil, name: @process_name)
  end

  def exit() do
    Process.exit(@process_name, :normal)
  end
  ...
  def add(a, b) do
    GenServer.call(@process_name, {:add, a, b})
  end

  def subtract(a, b) do
    GenServer.call(@process_name, {:subtract, a, b})
  end

  def multiply(a, b) do
    GenServer.call(@process_name, {:multiply, a, b})
  end

  def divide(a, b) do
    GenServer.call(@process_name, {:divide, a, b})
  end
